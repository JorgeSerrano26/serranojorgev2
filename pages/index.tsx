...
const Home: NextPage<Props> = ({ projects }) => {
    return (
        <Layout>
            <FloatingMenu items={[
                { href: "https://github.com/JorgeSerrano26", icon: "github", ariaLabel: "jorge github" },
                { href: "twitch.tv/jorgeserrano", icon: "twitch", ariaLabel: "jorge twitch", disabled: true },
                { href: "https://www.linkedin.com/in/jorge-serrano-a6b627162/", icon: "linkedin", ariaLabel: "jorge linkedin" }
            ]} />
