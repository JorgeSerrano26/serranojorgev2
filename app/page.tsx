		...
		<main>
			...
			>
				<div className="text-center">
					<h1 className="inline-block z-1 relative text-4xl font-semibold mb-10 after:content-[''] after:w-full after:h-3 after:block after:absolute after:bg-fuchsia-500 after:top-[75%] after:z-[-1]">
						Experience
					</h1>
				</div>
